...
function App() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-blue-100 via-violet-50 to-pink-50 px-4 py-8">
      <main className="mx-auto w-full max-w-4xl">
        <section className="mb-5 text-center animate-fade-in bg-blue-200 rounded-2xl border border-purple-100">
